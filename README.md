...
is used. You can open the GUI application [J-Link RTT viewer](https://www.segger.com/products/debug-probes/j-link/tools/rtt-viewer/) 
...
* On nRF52840-Dongle: The debugging is instead UART based and you will need
