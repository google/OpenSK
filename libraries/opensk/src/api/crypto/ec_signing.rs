...
pub trait Ecdsa {
    type SecretKey: EcSecretKey<PublicKey = Self::PublicKey, Signature = Self::Signature>;
    type PublicKey: EcPublicKey<Signature = Self::Signature>;
    type Signature: EcSignature;
}

/// Container for all Ed25519 cryptographic material.
#[cfg(feature = "ed25519")]
pub trait Ed25519 {
    type SecretKey: EdSecretKey<PublicKey = Self::PublicKey, Signature = Self::Signature>;
    type PublicKey: EdPublicKey<Signature = Self::Signature>;
    type Signature: EdSignature;
}

/// ECDSA signing key.
pub trait EcSecretKey: Sized {
